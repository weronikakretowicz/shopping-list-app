...
export const registerSchema = z
  .object({
    ...
    passwordConfirm: z.string().min(1, { message: "Repeated password is required" }),
    termsAndConditions: z.boolean().refine((value: unknown) => value, {
      message: "You must accept the terms and conditions",
    }),
  })
  .refine((data: { password: unknown; passwordConfirm: unknown }) => data.password === data.passwordConfirm, {
