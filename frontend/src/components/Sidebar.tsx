...
const BUTTON_STYLE = "w-full h-[60px] text-[18px] font-medium flex items-center justify-start gap-4";
    ...
    <nav className="flex flex-col justify-between w-full h-full">
      ...
      <div className="flex">
        <div className="flex justify-center items-end m-2">
          <Button className="h-12 bg-transparent border" onClick={handleThemeToggle}>
